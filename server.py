...
# Render:
#
# OLLAMA_HOST=https://your-cloudflare-url.trycloudflare.com
#
...
def test_ollama_connection():
    ...
    """
    ACTUALLY tests Render -> Cloudflare -> Ollama.
...
def health():
    ...
    return jsonify({
        ...
        # NEW:
        # This proves whether Render can actually
        # reach Ollama.

        "ollama_connection":
            ollama_test["connected"],
